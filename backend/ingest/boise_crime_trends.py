"""
backend/ingest/boise_crime_trends.py
task: data-068
lane: data
...
Usage:
  python backend/ingest/boise_crime_trends.py
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ingest Boise BPD crime trends by district from ArcGIS FeatureServer."
    )
