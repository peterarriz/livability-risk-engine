...
# ---------------------------------------------------------------------------
# Auth: custom register/login/google endpoints removed (2026-03-30).
# All user auth is now via Clerk. Only /auth/sync (Clerk webhook) remains.
# get_current_user/get_current_user_optional in auth.py still used by
# /save, /dashboard, /watchlist for custom JWT session (legacy).
# ---------------------------------------------------------------------------
