...
Toledo OH crime trends ingest — STUB (no public API).
...
Output:
  data/raw/toledo_crime_trends.json — 0-record staging file
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Toledo OH crime trends — STUB (no public API available)."
    )
...
def main() -> None:
    args = parse_args()
    print("Toledo OH: no public crime data API available.")
