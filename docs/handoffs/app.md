...
- Out-of-scope product routes such as pricing, portfolio, bulk, dashboard, account, sign-in, neighborhood, widget, and pilot evidence now redirect to `/app` during the launch demo.
